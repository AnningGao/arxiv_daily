...
*Figure removed (figure-file cleanup): fig3_axis_profiles.pdf*
...
*Figure removed (figure-file cleanup): h1-mf_final_2.pdf*
...
*Figure removed (figure-file cleanup): kSZ_compare_hvel_vrec_CAP_beam.png*
...
*Figure removed (figure-file cleanup): PyHermes-Workflow.png*
...
*Figure removed (figure-file cleanup): perfTkrel_allDM_AxiE.pdf*
...
*Figure removed (figure-file cleanup): fig_tradeoff.png*
...
*Figure removed (figure-file cleanup): fig03_transition_mismatch_distribution_counts_full.pdf*
...
*Figure removed (figure-file cleanup): fig-starplane.pdf*
