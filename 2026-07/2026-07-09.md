...
*Figure removed (figure-file cleanup): w0_omega_q0_plane.png*
...
*Figure removed (figure-file cleanup): generalization_gap.png*
...
*Figure removed (figure-file cleanup): desi_to_euclid_examples.png*
