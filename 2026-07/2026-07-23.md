...
*Figure removed (figure-file cleanup): dm_to_galaxies_volume.png*
...
*Figure removed (figure-file cleanup): fieldlevel_vs_summaries.pdf*
...
*Figure removed (figure-file cleanup): evidence_npe_architecture.pdf*
...
*Figure removed (figure-file cleanup): j2329_absorption_limit.pdf*
...
*Figure removed (figure-file cleanup): eps_posterior_104h.pdf*
...
*Figure removed (figure-file cleanup): line_ridges_dust.pdf*
...
*Figure removed (figure-file cleanup): void_depth_required.png*
...
*Figure removed (figure-file cleanup): wz_reconstruction.pdf*
...
*Figure removed (figure-file cleanup): neutrino_event_counts.pdf*
...
*Figure removed (figure-file cleanup): dh_ratio_comparison.jpeg*
