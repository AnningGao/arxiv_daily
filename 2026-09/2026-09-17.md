...
*Figure removed (figure-file cleanup): EW_comparison.pdf*
...
*Figure removed (figure-file cleanup): NHI_temperature_maps.png*
...
*Figure removed (figure-file cleanup): Pge_bandpowers.pdf*
...
*Figure removed (figure-file cleanup): halo_VPF_z0.pdf*
...
*Figure removed (figure-file cleanup): SHMR.png*
...
*Figure removed (figure-file cleanup): dark_matter_fractions.pdf*
...
*Figure removed (figure-file cleanup): MLSI_PINN_workflow.png*
...
*Figure removed (figure-file cleanup): score_manifold_overview.pdf*
...
*Figure removed (figure-file cleanup): model_leaderboard.pdf*
