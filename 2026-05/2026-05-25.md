...
*Figure removed (figure-file cleanup): core.pdf*
...
*Figure removed (figure-file cleanup): figure_maps_nbody_vs_fm.png*
*Figure removed (figure-file cleanup): results_overview.png*
...
*Figure removed (figure-file cleanup): toy_model.pdf*
*Figure removed (figure-file cleanup): marginal_spectra.pdf*
...
*Figure removed (figure-file cleanup): param_space.pdf*
...
*Figure removed (figure-file cleanup): tau.pdf*
*Figure removed (figure-file cleanup): snr.pdf*
...
*Figure removed (figure-file cleanup): qso_v0_3_2_methods_overview.png*
...
*Figure removed (figure-file cleanup): SB_GCE_40X40_cleaned.pdf*
*Figure removed (figure-file cleanup): E2dNdE_GCE_band_ebins_comparison.pdf*
