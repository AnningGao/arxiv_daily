...
*Figure removed (figure-file cleanup): gnn_scheme.pdf*
*Figure removed (figure-file cleanup): roc_comparison.pdf*
...
*Figure removed (figure-file cleanup): slice_dm_alpha_heiii_mw_hefrac.pdf*
*Figure removed (figure-file cleanup): whole_with_zoom_callout.pdf*
...
*Figure removed (figure-file cleanup): fig1.png*
*Figure removed (figure-file cleanup): galaxy_grid.png*
...
*Figure removed (figure-file cleanup): MainSeq_SFH.pdf*
*Figure removed (figure-file cleanup): DefaultvsAssimilated_2.pdf*
...
*Figure removed (figure-file cleanup): mass_dependent_spin_ppds.pdf*
*Figure removed (figure-file cleanup): fraction_hyperparams.pdf*
...
*Figure removed (figure-file cleanup): rdH0_vs_omegam.pdf*
*Figure removed (figure-file cleanup): Nfld.pdf*
