...
*Figure removed (figure-file cleanup): variance_reduction_diag_ell0_ell0_realistic.pdf*
*Figure removed (figure-file cleanup): chi2_avg.pdf*
...
*Figure removed (figure-file cleanup): dq2_emulator.drawio.pdf*
*Figure removed (figure-file cleanup): calibration_w_testset.pdf*
...
*Figure removed (figure-file cleanup): boost_mnu.pdf*
*Figure removed (figure-file cleanup): pk_conv_res.pdf*
...
*Figure removed (figure-file cleanup): architecture_overview.pdf*
*Figure removed (figure-file cleanup): c2st_comparison.pdf*
...
*Figure removed (figure-file cleanup): posterior_comparison.pdf*
*Figure removed (figure-file cleanup): coverage.pdf*
...
*Figure removed (figure-file cleanup): bias_averaged_pbs_with_sink_only_meff12_legend.pdf*
...
*Figure removed (figure-file cleanup): plot_wp_xi.png*
*Figure removed (figure-file cleanup): bispectrum_plot.png*
...
*Figure removed (figure-file cleanup): density_local_evolution_compare.pdf*
*Figure removed (figure-file cleanup): nstream_vs_radius.pdf*
...
*Figure removed (figure-file cleanup): bonfire_smf_comparison_resampled.png*
*Figure removed (figure-file cleanup): SFE_evolution_new.png*
...
*Figure removed (figure-file cleanup): fig4.pdf*
